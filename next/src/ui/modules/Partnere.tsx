				...
				<div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
					<div className="mx-auto w-full max-w-xl lg:mx-0">
						...
						<div className="mt-8 flex items-center gap-x-6">
							...
							<a
								href="#"
								className="group inline-flex items-center gap-1 text-sm font-semibold text-navy transition-colors hover:text-brand"
							>
								Kontakt oss!{' '}
								<span
									aria-hidden="true"
					...
					<div className="mx-auto grid w-full max-w-xl grid-cols-2 items-center gap-6 lg:mx-0 lg:max-w-none lg:pl-8">
						<div className="flex items-center justify-center rounded-2xl border border-navy-100 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-brand/30 hover:shadow-card-hover">
							<Image
